...
1. After updating file [route.py](back_end/app/route.py), you may need to [rebuild uwsgi with pcre support](https://stackoverflow.com/questions/21669354/rebuild-uwsgi-with-pcre-support), follow the instructions and do them in the virtual environment. Or you can set "auto-reload" in uwsgi.
...
5. Use [Ajax](http://api.jquery.com/jquery.ajax/ "jQuery API Documentation") to communicate between the server and the coach management system(web).
